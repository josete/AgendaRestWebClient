...
import servicios.ValidarAgendaService;
...
public class ComprobarAgenda extends HttpServlet {
     ...
     */
    static ValidarAgendaService validarAgendaService = new ValidarAgendaService();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String b = validarAgendaService.putXml(Paths.get(archivo.getSubmittedFileName()).toFile());
